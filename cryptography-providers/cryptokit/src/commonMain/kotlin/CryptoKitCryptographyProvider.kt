...
internal object CryptoKitCryptographyProvider : CryptographyProvider() {
    ...
    override fun <A : CryptographyAlgorithm> getOrNull(identifier: CryptographyAlgorithmId<A>): A? = when (identifier) {
        MD5    -> CryptoKitDigest(MD5, SwiftHash::md5)
        SHA1   -> CryptoKitDigest(SHA1, SwiftHash::sha1)
        SHA256 -> CryptoKitDigest(SHA256, SwiftHash::sha256)
        SHA384 -> CryptoKitDigest(SHA384, SwiftHash::sha384)
        SHA512 -> CryptoKitDigest(SHA512, SwiftHash::sha512)
//        HMAC    ->
//        AES.GCM ->
//        ECDSA   ->
//        ECDH   ->
