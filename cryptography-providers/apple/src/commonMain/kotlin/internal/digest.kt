...
internal fun CryptographyAlgorithmId<Digest>.ecdsaSecKeyAlgorithm(): SecKeyAlgorithm? = when (this) {
    SHA1   -> kSecKeyAlgorithmECDSASignatureDigestX962SHA1
    SHA224 -> kSecKeyAlgorithmECDSASignatureDigestX962SHA224
    SHA256 -> kSecKeyAlgorithmECDSASignatureDigestX962SHA256
    SHA384 -> kSecKeyAlgorithmECDSASignatureDigestX962SHA384
    SHA512 -> kSecKeyAlgorithmECDSASignatureDigestX962SHA512
    else   -> throw CryptographyException("Unsupported hash algorithm: $this")
}
