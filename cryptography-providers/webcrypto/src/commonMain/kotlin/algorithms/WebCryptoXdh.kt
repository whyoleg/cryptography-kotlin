...
internal object WebCryptoXdh : XDH {
    ...
    private val publicKeyWrapper = WebCryptoKeyWrapper<XDH.PublicKey>(arrayOf()) { XdhPublicKey(it) }
    ...
    override fun privateKeyDecoder(curve: XDH.Curve): KeyDecoder<XDH.PrivateKey.Format, XDH.PrivateKey> = WebCryptoKeyDecoder(
        ...
        keyWrapper = WebCryptoKeyWrapper(arrayOf("deriveBits")) { XdhPrivateKey(it, publicKeyWrapper) },
    )
    ...
    override fun keyPairGenerator(curve: XDH.Curve): KeyGenerator<XDH.KeyPair> = WebCryptoAsymmetricKeyGenerator(
        ...
        keyPairWrapper = { XdhKeyPair(XdhPublicKey(it.publicKey), XdhPrivateKey(it.privateKey, publicKeyWrapper)) },
    )
    ...
    private class XdhPrivateKey(
        ...
        private val publicKeyWrapper: WebCryptoKeyWrapper<XDH.PublicKey>,
