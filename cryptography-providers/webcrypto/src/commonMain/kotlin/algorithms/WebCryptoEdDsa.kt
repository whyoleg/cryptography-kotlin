...
internal object WebCryptoEdDsa : EdDSA {
    ...
    private val publicKeyWrapper = WebCryptoKeyWrapper<EdDSA.PublicKey>(arrayOf("verify")) { EdDsaPublicKey(it) }
    ...
    override fun privateKeyDecoder(curve: EdDSA.Curve): KeyDecoder<EdDSA.PrivateKey.Format, EdDSA.PrivateKey> = WebCryptoKeyDecoder(
        ...
        keyWrapper = WebCryptoKeyWrapper(arrayOf("sign")) { EdDsaPrivateKey(it, publicKeyWrapper) },
    )
    ...
    override fun keyPairGenerator(curve: EdDSA.Curve): KeyGenerator<EdDSA.KeyPair> = WebCryptoAsymmetricKeyGenerator(
        ...
        keyPairWrapper = { EdDsaKeyPair(EdDsaPublicKey(it.publicKey), EdDsaPrivateKey(it.privateKey, publicKeyWrapper)) },
    )
    ...
    private class EdDsaPrivateKey(
        ...
        private val publicKeyWrapper: WebCryptoKeyWrapper<EdDSA.PublicKey>,
