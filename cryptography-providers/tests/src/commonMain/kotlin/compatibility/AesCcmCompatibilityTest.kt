...
abstract class AesCcmCompatibilityTest(provider: CryptographyProvider) :
    AesBasedCompatibilityTest<AES.CCM.Key, AES.CCM>(AES.CCM, provider) {
    ...
    override suspend fun CompatibilityTestScope<AES.CCM>.generate(isStressTest: Boolean) {
        ...
        val tagSizes = listOf(64, 128)
        val ivSizes = listOf(12, 7, null)
    ...
    override suspend fun CompatibilityTestScope<AES.CCM>.validate() {
