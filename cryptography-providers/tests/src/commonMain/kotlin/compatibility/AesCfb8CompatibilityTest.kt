...
abstract class AesCfb8CompatibilityTest(provider: CryptographyProvider) :
    AesBasedCompatibilityTest<AES.CFB8.Key, AES.CFB8>(AES.CFB8, provider) {
    ...
    override suspend fun CompatibilityTestScope<AES.CFB8>.generate(isStressTest: Boolean) {
    ...
    override suspend fun CompatibilityTestScope<AES.CFB8>.validate() {
