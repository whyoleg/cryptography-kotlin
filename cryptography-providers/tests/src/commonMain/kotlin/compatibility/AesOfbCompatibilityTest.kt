...
abstract class AesOfbCompatibilityTest(provider: CryptographyProvider) :
    AesBasedCompatibilityTest<AES.OFB.Key, AES.OFB>(AES.OFB, provider) {
    ...
    override suspend fun CompatibilityTestScope<AES.OFB>.generate(isStressTest: Boolean) {
    ...
    override suspend fun CompatibilityTestScope<AES.OFB>.validate() {
