...
abstract class AesCmacTestvectorsTest(provider: CryptographyProvider) : AlgorithmTest<CMAC>(CMAC, provider) {
    ...
    private fun testCase(key: String, salt: String, expected: String) = testWithAlgorithm {
    ...
    fun testDiversifyKeyCase1() = testCase(
        ...
        salt = "6bc1bee22e409f96e93d7e117393172a",
        expected = "070a16b46b4d4144f79bdd9dd04a287c"
    )

    @Test
    fun testDiversifyKeyCase2() = testCase(
        key = "2b7e151628aed2a6abf7158809cf4f3c",
        salt = "6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e5130c81c46a35ce411",
        expected = "dfa66747de9ae63030ca32611497c827",
    )

    @Test
    fun testDiversifyKeyCase3() = testCase(
        key = "2b7e151628aed2a6abf7158809cf4f3c",
        salt = "6bc1bee22e409f96e93d7e117393172aae2d8a571e03ac9c9eb76fac45af8e5130c81c46a35ce411",
        expected = "dfa66747de9ae63030ca32611497c827",
    )
    ...
    @Test
    fun testDiversifyKeyCase4() = testCase(
