...
/**
 * Algorithm identifier for EC keys in SubjectPublicKeyInfo/PrivateKeyInfo.
 */
...
@Deprecated(
    ...
    replaceWith = ReplaceWith("EcAlgorithmIdentifier", "dev.whyoleg.cryptography.serialization.asn1.modules.EcAlgorithmIdentifier"),
